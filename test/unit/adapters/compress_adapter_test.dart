...
void main() {
  group('$CompressAdapter', () {
    ...
    test('compress invokes xz process', () async {
      final inStream = Stream.value(List.generate(100, (index) => index));
      ...
      await expectLater(stream, emitsInOrder(<dynamic>[outData, emitsDone]));

      verify(
        () => mockProcessAdapter.streamRaw('xz', [
          '--compress',
          '-9',
          '--threads',
